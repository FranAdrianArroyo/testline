...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body  style="background:#eee;">
    <div class="header">
      <div class="row">
        <div class="col-lg-6">
          <span class="logo">Sistema de Exámenes en línea</span>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-tasks" aria-hidden="true"></span>&nbsp;Evaluación<span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><a href="dash_teacher.php?q=4">Agregar Evaluación</a></li>
                <li><a href="dash_teacher.php?q=5">Eliminar Evaluación</a></li>
              </ul>
            </li>
              ...
              while($row = mysqli_fetch_array($result)) {
                ...
                echo '
                    <tr>
                      ...
                      <td>
                        <b>
                          <a href="update_teacher.php?q=rmquiz&eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:red">
              ...
              while($row = mysqli_fetch_array($result)) {
                ...
                echo '
                    <tr>
                      ...
                      <td>
                        <b>
                          <a href="dash_teacher.php?q=8&eid='.$eid.'" class="pull-right btn sub1" style="margin:0px;background:#48A8D1">
          ...
          <?php 
            if(@$_GET['q']==1) {
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-12">
                              ...
                              <select id="career" name="career" placeholder="Elija la carrera" class="form-control input-md" required>
                                <option value="">&#128218;  Selecciona una cerrera</option>
              ...
              echo '
                    ...
                    <div class="col-md-6">
                      <label style="color:#080C3E; font-size:32px;">ALUMNOS REGISTRADOS</label>
                      <div class="form-1-2">
