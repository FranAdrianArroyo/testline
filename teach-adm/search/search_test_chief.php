<?php
    ...
    $query = "SELECT * FROM quiz WHERE career = '$career' ORDER BY groupnum, subject";
    $salida = "";

    if(isset($_POST['consulta'])){
      $q = $con->real_escape_string($_POST['consulta']);
      $query = "SELECT * FROM quiz WHERE career = '$career' AND groupnum LIKE '%".$q."%' OR subject LIKE '%".$q."%' ORDER BY employnumber, subject";
    }
