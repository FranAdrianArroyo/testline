...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body  style="background:#eee;">
    <div class="header">
      <div class="row">
        <div class="col-lg-6">
          <span class="logo">Sistema de Evaluaciones Online</span>
        </div>
        ...
        <?php
          ...
          if(!(isset($_SESSION['email']))){
            ...
            include_once 'dbConnection.php';
            echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hola '.$name.'</span> &nbsp;|&nbsp;<a href="logout_admin.php?q=dash.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Cerrar Sesión</button></a></span>';
          }
        ?>
      </div>
    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="dash.php?q=0"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Inicio<span class="sr-only">(current)</span></a></li>
            <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="dash.php?q=1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;Profesores</a></li>
		        <li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="dash.php?q=3"><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span>&nbsp;Observaciones</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </div><!-- /.container-fluid -->
          ...
          <?php
            ...
            if(@$_GET['q']==4) {
              ...
              echo'
                  ...
                  <b>
                    <a href="dash.php?q=0" class="pull-right btn sub1" style="margin:0px;background:#9B9999;width:130px;">
                  ...
                  <b>
                    <a href="generate_pdf.php?eid='.$eid.'" target="_blank" class="pull-right btn sub1" style="margin:0px;background:#64D852;width:150px;">
          ...
          <?php 
            if(@$_GET['q']==3) {
              ...
              while($row = mysqli_fetch_array($result)) {
                ...
                $id = $row['id'];
	              echo '<tr><td>'.$c++.'</td>';
	              echo '<td><a title="Clic para ver la observación" href="dash.php?q=3&fid='.$id.'">'.$subject.'</a></td><td>'.$schoolnumber.'</td><td>'.$date.'</td><td>'.$time.'</td><td>'.$name.'</td>
